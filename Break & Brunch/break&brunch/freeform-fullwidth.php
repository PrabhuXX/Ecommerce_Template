...
<body id="freeform" class="fullwidth">
			...
			<div class="row">
				...
				<div class="col-lg-3">
					...
					<ul id="translation-links">
						<li><button type="button" id="translate-button" aria-label="translate website" aria-haspopup="true" aria-expanded="false">EN <i class="fa fa-angle-down"></i></button>
	...
	<section id="slider" class="tiny-slider-wrap">
		<ul class="tiny-slider">
			<li class='tiny-item'>
				<div class="tns-lazy-img tns-bg-slide" data-style="background:url('_assets_/images/slide-2.jpg') center no-repeat;background-size:cover"></div>
			</li>
		</ul><!--/.tiny-slider-->
	</section><!--/#slider-->
	...
	<main id="main">
		<div class="container">
			<article id="entry">
				...
				<h1 id="page-title">Page Title Lorem Dolor</h1>
				<div id="post">
					<p>Nulla vitae elit libero, a pharetra augue. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus sagittis lacus vel augue laoreet</p>
					<img src="_assets_/images/placeholder.jpg" alt="placeholder image">
					<p>Sed posuere consectetur est at lobortis. Vestibulum id ligula porta felis euismod semper. Curabitur blandit tempus porttitor. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id ligula porta felis euismod semper. Sed posuere consectetur est at lobortis. Maecenas faucibus mollis interdum.</p>
					<ul>
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam id dolor id nibh ultricies vehicula ut id elit. Donec id elit non mi porta gravida at eget metus. Donec sed odio dui. Nulla vitae elit libero, a</p>
					<blockquote>“Duis mollis, est non commodo luc tus, nisi erat porttitor ligula, eget lacinia.Nullam quis risus eget urna mollis ornare vel eu leo pellentesque”</blockquote>
					<p>Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Vestibulum id ligula porta felis euismod semper. Etiam porta sem malesuada magna mollis euismod. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div><!--/#post-->
			</article><!--/#entry-->
		</div><!--/.container-->
	...
	<footer>
		<img src="_assets_/images/footer-border.png" alt="footer border">
		<div id="footer-top">
			<div class="container">
				<div class="row">
					<div class="col-lg-3">
						<h3>FAQs</h3>
						<ul>
							<li><a href="./">Purus Mollis Fusce</a></li>
							<li><a href="./">Ultricies Condimentum</a></li>
							<li><a href="./">Venenatis Ullamcorper</a></li>
							<li><a href="./">Risus Commodo Viverra</a></li>
						</ul>
					</div><!--/.col-lg-3-->
					<div class="col-lg-3">
						<h3>helpful links</h3>
					...
					<div class="col-lg-3">
						<h3>contact</h3>
						<ul>
							<li><a href="./">12 Second Street, Presque Isle, ME 04769</a></li>
							<li><a href="tel:2077602700">Phone: (207) 760-2700</a></li>
		...
		<div id="social">
			...
			<div id="social-media-links">
				<a href="./" class="sml"><img src="_assets_/images/fb.png" alt="facebook link"></a>
				<a href="./" class="sml"><img src="_assets_/images/ig.png" alt="instagram link"></a>
				<a href="./" class="sml"><img src="_assets_/images/in.png" alt="linkedin link"></a>
				<a href="./" class="sml"><img src="_assets_/images/tt.png" alt="tiktok link"></a>
				<a href="./" class="sml"><img src="_assets_/images/tw.png" alt="twitter link"></a>
				<a href="./" class="sml"><img src="_assets_/images/yt.png" alt="youtube link"></a>
		...
		<div id="footer-bot">
			<div class="container">
				<div class="row">
					<div class="col-lg-6">
						&copy; 2022 Presque Isle, ME
					</div><!--/.col-lg-6-->
					<div class="col-lg-6 text-lg-right" id="revize">
						Powered by <a href="https://www.revize.com" id="revize-link">revize.</a>, the Government Website Experts. | <a href="./" id="revize-login"><strong>Login</strong></a>
					</div><!--/.col-lg-6.text-lg-right#revize-->
				</div><!--/.row-->
			</div><!--/.container-->
		</div><!--/#footer-bot-->
	</footer>
